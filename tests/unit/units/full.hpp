...
#define UT_NAME full
#define UT_DESC "Full library with compilation options (only compiled with OMNI_UT_FULL)"
...
class UT_CLASS_DEF
{
    public:
        ...
        void info_test()
        {
            ...
            print_info(omni::geometry::size32_t);
            ...
            print_info(omni::geometry::circle_t);
            print_info(omni::geometry::circle64_t);
            print_info(omni::geometry::circleF_t);
            print_info(omni::geometry::triangle_t);
            print_info(omni::geometry::triangle64_t);
            print_info(omni::geometry::triangleF_t);
            print_info(omni::geometry::quadrilateral_t);
            print_info(omni::geometry::quadrilateral64_t);
            print_info(omni::geometry::quadrilateralF_t);
