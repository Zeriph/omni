...
odir=/Code/omni
tdir=${odir}/tests
flags="-DNDEBUG -D_CONSOLE -D_UNICODE -DUNICODE -DOMNI_DISPOSE_EVENT -DOMNI_OBJECT_NAME -DOMNI_TYPE_INFO -DOMNI_SAFE_LIBRARY  -DOMNI_NON_PORTABLE -I../../source -I. -fexceptions -O3"
